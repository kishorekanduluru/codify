...
<div class="container">
{{ Form::open(array('url' => '/user/test/DOT/Individual/resourcesSelection', 'class'=>'form-Div')) }}
...
<div class="row submit-btn">
		...
		<a id="modal-659898" href="#modal-container-659898" role="button" class="btn btn-primary btn pull-right" data-toggle="modal" onclick="resourcesConfirm()">Submit</a>
		</div>
	</div>
{{ Form::close() }} 
</div>
	 ...
	 if(selectedUnits.length <= 0){
        ...
        $('.modalContainer').append('<div class="container">'+
				...
				'<div class="col-md-12 column">'+
					...
					'<div class="modal fade" id="modal-container-659898" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'+
