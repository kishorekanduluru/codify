...
<body onLoad>
<div class="container">
{{ Form::open(array('url' => '/user/test/DOT/Individual/filerDetails', 'class'=>'form-Div')) }}
...
$(document).ready(function() {
	$( "#left_menu" ).empty();
	$("#left_menu").append('<li><a href="/nlab/user/resourceReservation"><span class="tab">TestFocus-></span></a></li>');
	$("#left_menu").append('<li><a href="/nlab/user/resourceReservation"><span class="tab">Reservation-></span></a></li>');
	$("#left_menu").append('<li class="list"><span class="tab">DOT Install Options</span></li>');
