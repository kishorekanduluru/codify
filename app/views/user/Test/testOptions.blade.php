...
<div class="panel-body">
	...
	<div class="selnresources" style="display:inline-block"><input type="radio" name="ResourceSeln" onchange="" value="Individual"  checked> Individually</div>
...
$(document).ready(function() {
	...
	$("#left_menu").append('<li class="list"><span class="tab">TestFocus</span></li>');
