...
<div class="row submit-btn">
		...
		<a id="modal-65" href="#modal-container-65" role="button" class="btn btn-primary btn pull-right" data-toggle="modal" onclick="resourcesConfirm()">Submit</a>
		</div>
	</div>
{{ Form::close() }} 
</div>
	...
	for(var i=0;i<chks.length;i++)
	{
        ...
        $('.modalContainer').append('<div class="container">'+
				...
				'<div class="col-md-12 column">'+
					...
					'<div class="modal fade" id="modal-container-65" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'+
