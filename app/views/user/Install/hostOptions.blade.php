...
<body onLoad>
<div class="container">
{{ Form::open(array('route' => array('host.OSinstall',$resources),'class'=>'form-Div')) }}
...
// 		});
 $(document).ready(function() {
	...
	$("#left_menu").append('<li class="list"><span class="tab">HostOptions</span></li>');
...
//	alert(selectObjid );
    ...
    $.get('installation/ajax-osver?id=' + osId,function(data){
